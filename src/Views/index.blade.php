                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Table With Arts of Album <span
                            ...
                            <a href="{{ action('\Vadiasov\Ordering\Controllers\OrderingController@index', ['arts', $album->id]) }}"
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($arts as $art)
                                    <tr>
                                        ...
                                        @if($art->cover == 0)
                                            <td>
                                                <a href="{{action('\Vadiasov\ArtsAdmin\Controllers\ArtsController@setCover', [$album->id, $art->id])}}">
                                                    <i class="fa fa-ban" aria-hidden="true"></i></a>
                                            </td>
                                        @else
                                            <td>
                                                <a href="{{action('\Vadiasov\ArtsAdmin\Controllers\ArtsController@notCover', [$album->id, $art->id])}}">
                                        ...
                                        <td>
                                            <a href="{{action('\Vadiasov\ArtsAdmin\Controllers\ArtsController@destroy', [$album->id, $art->id])}}">
